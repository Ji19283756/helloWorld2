...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2005, 6, 1), 'is_honors':1, "email": "RobertSmith@terpmail.umd.edu"},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,
         'birth_date': dt.datetime(2004, 3, 24), 'is_honors': 0, "email": "LeoMunching@terpmail.umd.edu"},
    ]
